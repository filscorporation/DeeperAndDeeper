...
{
    public class UIWinScreen : ScriptComponent
    {
        private static Sprite _panelSprite = null;
        private static Sprite panelSprite => _panelSprite ?? (_panelSprite = ResourcesManager.LoadImage("win_screen.png"));
        ...
        {
            Entity entity = UI.CreateUIElement("Win screen");
            ...
            UIWinScreen element = entity.AddComponent<UIWinScreen>();
            element.CreateInner();
        ...
        private void CreateInner()
        {
            ...
            uiText1.Text = "You reached lava as unlimited source of heat and won!";
            uiText1.TextSize = 64;
